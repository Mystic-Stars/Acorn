...
<ArticleCodeBlock code={"async function registerMsgDisplayScript() {\n await messenger.messageDisplayScripts.register({\n js: [{file: \"/content_script.js\"}, {file: \"/content_start.js\"}]\n });\n }\n registerMsgDisplayScript();"} />
